        ...
        public string Value
        {
            get
            {
                _value = @"<el-form-item label='"+ _frontLabelName + @"'>
                        <el-date-picker value-format='yyyy-MM-dd' v-model='" + _modelName + @"' unlink-panels type='daterange' range-separator='至' start-placeholder='开始日期' end-placeholder='结束日期' :picker-options='pickerOptions'>
                        </el-date-picker>
                    </el-form-item>";
                return _value;
